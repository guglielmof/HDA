function [distances, ssd_pairs] = compute_ssd_pairs(measure, metric, varargin) 
    common_parameters;
    ...
    data_orig(isnan(data_orig{:,'alpha'}),'alpha') = num2cell(zeros(sum(isnan(data_orig{:,'alpha'})), 1));
